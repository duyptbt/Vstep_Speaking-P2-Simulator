...
export const TestModeView: React.FC<TestModeViewProps> = ({
  ...
  return (
    <div className="max-w-7xl mx-auto px-3 sm:px-6 py-6">
      {/* 1. IDLE / START BANNER */}
      {phase === "idle" && (
        <div className={`${theme.cardBg} border ${theme.cardBorder} rounded-3xl p-6 sm:p-12 text-center shadow-xl relative overflow-hidden`}>
          <div className="absolute top-0 left-0 right-0 h-2 bg-gradient-to-r from-amber-500 via-rose-500 to-indigo-500" />

          <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-2xl bg-amber-500/10 border border-amber-500/30 text-amber-500 flex items-center justify-center mx-auto mb-6 shadow-inner">
            <Clock className="w-8 h-8 sm:w-10 sm:h-10" />
          </div>

          <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-amber-500/10 border border-amber-500/30 text-amber-600 dark:text-amber-300 text-xs font-bold uppercase tracking-wider mb-3">
            VSTEP Solution Discussion (Thảo Luận Giải Pháp)
          </span>

          <h2 className={`text-2xl sm:text-4xl font-extrabold ${theme.textPrimary} mb-3 tracking-tight`}>
            VSTEP Speaking Part 2 Test Simulator
          </h2>

          <p className={`text-sm sm:text-base ${theme.textSecondary} max-w-2xl mx-auto mb-8 leading-relaxed`}>
          ...
          {errorMessage && (
            <div className="mb-6 p-4 bg-rose-500/10 border border-rose-500/30 rounded-xl text-rose-600 dark:text-rose-300 text-xs sm:text-sm flex items-center gap-2 max-w-lg mx-auto">
          ...
          {/* Test Structure Box */}
          <div className={`${theme.subCardBg} border ${theme.subCardBorder} rounded-2xl p-6 max-w-xl mx-auto mb-8 text-left space-y-4 shadow-xs`}>
            ...
            <div className={`text-xs sm:text-sm ${theme.textSecondary} space-y-2.5`}>
              <div className="flex items-start gap-3">
                <span className="w-6 h-6 rounded-lg bg-amber-500/20 text-amber-700 dark:text-amber-300 border border-amber-500/30 font-bold text-xs flex items-center justify-center flex-shrink-0 mt-0.5">
                  1
                </span>
                <p>
              ...
              <div className="flex items-start gap-3">
                <span className="w-6 h-6 rounded-lg bg-rose-500/20 text-rose-700 dark:text-rose-300 border border-rose-500/30 font-bold text-xs flex items-center justify-center flex-shrink-0 mt-0.5">
                  2
                </span>
                <p>
              ...
              <div className="flex items-start gap-3">
                <span className="w-6 h-6 rounded-lg bg-indigo-500/20 text-indigo-700 dark:text-indigo-300 border border-indigo-500/30 font-bold text-xs flex items-center justify-center flex-shrink-0 mt-0.5">
                  3
                </span>
                <p>
          ...
          <button
            ...
            className="px-8 py-4 bg-amber-600 hover:bg-amber-500 text-white rounded-2xl font-bold text-base sm:text-lg shadow-xl shadow-amber-600/30 hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center gap-3 mx-auto cursor-pointer"
          >
      ...
      {(phase === "prep" || phase === "response") && (
        <div className="space-y-6 animate-in fade-in duration-300">
          ...
          <div className={`${theme.cardBg} border ${theme.cardBorder} rounded-2xl p-4 sm:p-6 shadow-md flex flex-col md:flex-row items-center justify-between gap-4`}>
            
            {/* Timer Display */}
            <div className="flex items-center space-x-4">
              {phase === "prep" ? (
                <div className="flex items-center space-x-3">
                  <div className="px-4 py-2 rounded-xl bg-amber-500/20 border border-amber-500/40 text-amber-600 dark:text-amber-300 font-mono text-2xl font-extrabold flex items-center gap-2 animate-pulse">
                  ...
                  <div>
                    ...
                    <span className={`text-[11px] ${theme.textMuted}`}>Taking notes in split view</span>
                  </div>
                </div>
              ) : (
                <div className="flex items-center space-x-3">
                  <div className="px-4 py-2 rounded-xl bg-rose-500/20 border border-rose-500/40 text-rose-600 dark:text-rose-300 font-mono text-2xl font-extrabold flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <span className={`text-[11px] ${theme.textMuted}`}>Recording live response</span>
                  </div>
                </div>
              )}
            </div>
            ...
            <div className={`flex items-center space-x-4 ${theme.subCardBg} border ${theme.subCardBorder} px-4 py-2.5 rounded-xl w-full md:w-auto justify-between md:justify-start`}>
              {phase === "prep" ? (
                <div className="flex items-center space-x-2 text-xs text-amber-700 dark:text-amber-300 font-semibold">
                ...
                <div className="flex items-center space-x-4">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-xs font-semibold text-rose-600 dark:text-rose-300">Recording Speech</span>
                  </div>
            ...
            <div>
              {phase === "prep" ? (
                <button
                  ...
                  className="px-5 py-2.5 bg-rose-600 hover:bg-rose-500 text-white rounded-xl font-bold text-xs sm:text-sm shadow-md shadow-rose-600/30 transition flex items-center gap-2 w-full md:w-auto justify-center cursor-pointer"
                >
                ...
                <button
                  ...
                  className="px-5 py-2.5 bg-emerald-600 hover:bg-emerald-500 text-white rounded-xl font-bold text-xs sm:text-sm shadow-md shadow-emerald-600/30 transition flex items-center gap-2 w-full md:w-auto justify-center cursor-pointer"
                >
          ...
          {/* Time Progress Bar */}
          <div className={`w-full ${theme.isLight ? "bg-slate-200" : "bg-slate-800"} rounded-full h-2 overflow-hidden border ${theme.cardBorder}`}>
            {phase === "prep" ? (
              <div
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className={`${theme.cardBg} border ${theme.cardBorder} rounded-2xl p-5 sm:p-7 shadow-md space-y-6 flex flex-col justify-between`}>
              <div className="space-y-5">
                ...
                <div className={`flex items-center justify-between border-b ${theme.cardBorder} pb-3`}>
                  ...
                  <button
                    ...
                    className={`p-1.5 ${theme.btnSecondary} rounded-lg text-xs font-semibold transition flex items-center gap-1 cursor-pointer`}
                ...
                {/* Situation Box */}
                <div className={`${theme.subCardBg} border ${theme.subCardBorder} rounded-xl p-4 sm:p-5`}>
                  ...
                  {question.options.map((opt) => (
                    ...
                    >
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 pt-1 text-[11px]">
                        <div className={`${theme.isLight ? "bg-emerald-50/80 border-emerald-200 text-emerald-900" : "bg-emerald-950/30 border-emerald-800/30 text-emerald-300"} border rounded p-2`}>
                          <strong className="block text-emerald-700 dark:text-emerald-400 font-semibold mb-0.5">Advantages:</strong>
                        ...
                        <div className={`${theme.isLight ? "bg-rose-50/80 border-rose-200 text-rose-900" : "bg-rose-950/30 border-rose-800/30 text-rose-300"} border rounded p-2`}>
                          <strong className="block text-rose-700 dark:text-rose-400 font-semibold mb-0.5">Disadvantages:</strong>
                          <ul className="list-disc list-inside space-y-0.5">
                ...
                {/* Prompt Question */}
                <div className={`${theme.isLight ? "bg-amber-50/90 border-amber-300/80" : "bg-amber-500/10 border-amber-500/30"} border rounded-xl p-4`}>
                  <span className="text-xs font-bold text-amber-800 dark:text-amber-300 uppercase tracking-wider block mb-1">
                    Core Task Question:
                  </span>
                  <p className="text-xs sm:text-sm font-bold text-amber-950 dark:text-amber-100 leading-snug">
                    "{question.prompt}"
                  </p>
                </div>
              </div>
            ...
            <div className={`${theme.cardBg} border ${theme.cardBorder} rounded-2xl p-5 sm:p-7 shadow-md space-y-5 flex flex-col justify-between`}>
              <div className="space-y-4 flex-1 flex flex-col">
                ...
                <div className={`flex items-center justify-between border-b ${theme.cardBorder} pb-3`}>
                  ...
                  <div className="flex items-center space-x-2">
                    <button
                      ...
                      className={`px-2.5 py-1 ${theme.isLight ? "bg-amber-50 hover:bg-amber-100 text-amber-800 border-amber-300" : "bg-slate-800 hover:bg-slate-700 text-amber-300 border-slate-700"} rounded-lg text-xs font-medium transition border cursor-pointer`}
                ...
                <div className="flex-1 flex flex-col">
                  <textarea
                    ...
                    } border rounded-xl p-4 text-xs sm:text-sm focus:outline-none focus:ring-2 focus:ring-amber-500 font-mono leading-relaxed resize-none shadow-inner`}
                  />
                  <p className={`text-[11px] ${theme.textMuted} mt-1.5 flex items-center justify-between`}>
                ...
                <div className={`pt-2 border-t ${theme.cardBorder}`}>
                  <div className="flex items-center justify-between mb-1.5">
                    ...
                    <span className={`text-[10px] ${theme.textMuted}`}>Auto-transcribed</span>
                  </div>
                  <div className={`${
                    theme.isLight
                      ? "bg-slate-50 border-slate-200 text-slate-800"
                      : "bg-slate-950/90 border-slate-800 text-slate-300"
                  } border rounded-xl p-3.5 min-h-[75px] max-h-32 overflow-y-auto text-xs font-mono leading-relaxed`}>
                    {liveTranscript ? (
